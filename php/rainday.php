<?php
	...
	$string = "Regen in Liter pro 24 Stunden";
	...
	$string .= sprintf("  Minimum : %5.1fl/24h Maximum : %5.1fl/24h", $min_rain1, $max_rain1);
	...
	$string .= sprintf("  Minimum : %5.1fl/24h Maximum : %5.1fl/24h", $min_rain2, $max_rain2);
